...
| **Final Weight Verification** | Model weights after training must match reference | `weight_relative_error_max: 0.007` |
...
```json
{
    ...
    "verification": {
        ...
        "gradient_norm_ratio_max": 1.05,
        "weight_relative_error_max": 0.007
    },
