...
def setup_data(
    ...
    print(f"Setting up benchmark data:")
    ...
    dataset = dataset.shuffle(seed=BENCHMARK_SEED, buffer_size=10000)
    ...
    for i in range(num_samples):
        ...
        try:
            ...
            print(f"   Warning: Dataset exhausted at {i} samples")
            break
...
def main():
    ...
    if data_path.exists():
        ...
        setup_data(model_name, dataset_name, num_samples, sequence_length, data_path)
    print()
