...
def list_submissions(db_path: str):
    ...
    print("=" * 80)
    print(f"{'SUBMISSION':<20} {'UID':<5} {'STATUS':<10} {'TPS':<12} {'CODE':<10} {'SUBMITTED'}")
    print("=" * 80)
    ...
    for r in rows:
        ...
        print(f"{r['submission_id']:<20} {r['miner_uid']:<5} {r['status']:<10} {tps:<12} {code:<10} {created}")
...
Examples:
  ...
  uv run python scripts/view_submission.py commit_9303_1 --save
    ...
    parser.add_argument("--db", default="tournament.db", help="Database path")
    ...
    if not Path(db_path).exists():
        ...
        db_path = project_root / "tournament.db"
